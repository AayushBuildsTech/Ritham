  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        <Pressable style={styles.upload} onPress={pickFloorplan} android_ripple={{ color: Colors.goldFaint }}>
          {image ? (
            <Image source={{ uri: image.uri }} style={styles.preview} resizeMode="contain" />
          ) : (
            <>
              <Icon name="camera" size={32} color={Colors.gold} />
...
const styles = StyleSheet.create({
  ...
  label: { fontFamily: Fonts.bodySemibold, color: Colors.textMuted, fontSize: Fonts.size.xs, letterSpacing: 1.5, marginBottom: Spacing.sm, marginTop: Spacing.xs },
  input: {
  ...
  upload: {
    borderWidth: 1, borderColor: Colors.borderStrong, borderStyle: 'dashed', borderRadius: Radius.md,
    backgroundColor: Colors.surface, alignItems: 'center', justifyContent: 'center',
    paddingVertical: Spacing.xl, minHeight: 160, overflow: 'hidden', gap: 6,
  },
  uploadText: { fontFamily: Fonts.bodySemibold, color: Colors.text, fontSize: Fonts.size.md, marginTop: 6 },
  uploadHint: { fontFamily: Fonts.body, color: Colors.textDim, fontSize: Fonts.size.xs },
  preview: { width: '100%', height: 220, borderRadius: Radius.sm },
  changeLink: { fontFamily: Fonts.bodyMedium, color: Colors.goldLight, fontSize: Fonts.size.sm, marginTop: Spacing.sm, alignSelf: 'center' },

  chips: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm },
  chip: {
    borderWidth: 1, borderColor: Colors.border, borderRadius: Radius.pill, backgroundColor: Colors.surfaceSunken,
    paddingVertical: 8, paddingHorizontal: Spacing.md,
  },
  chipActive: { backgroundColor: Colors.gold, borderColor: Colors.gold },
  chipText: { fontFamily: Fonts.bodyMedium, color: Colors.textMuted, fontSize: Fonts.size.sm },
  chipTextActive: { fontFamily: Fonts.bodySemibold, color: Colors.canvas },
